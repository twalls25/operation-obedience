...
- [ ] Admin moderation toolkit: delete any comment (with a notification email), restrict/ban members, admin members list with one-off custom emails — code complete and build-verified, **pending Tyler's interactive test** (see notes)
